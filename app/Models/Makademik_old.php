...
class Makademik extends Model
{
    ...
    public function mahasiswa(Request $request)
    {
        ...
        h.alamat AS alamat_ayah,l.pekerjaan_singkatan AS pekerjaan_ayah
                ,i.rt AS rt_ibu,i.rw AS rw_ibu,h.kode_agama AS agama_ayah,i.kode_agama AS agama_ibu,h.kode_jenjang_pendidikan AS jenjangpendidikan_ayah,
                i.kode_jenjang_pendidikan AS jenjangpendidikan_ibu,
                i.kode_pos AS kode_pos_ibu,i.alamat AS alamat_ibu,m.pekerjaan_singkatan AS pekerjaan_ibu,h.kode_jenis_pekerjaan AS kode_pekerjaan_ayah,i.kode_jenis_pekerjaan AS kode_pekerjaan_ibu,
    ...
    public function edit_mahasiswa(Request $request)
    {
        ...
        DB::table('adm_ortu_ayah')
            ...
            ->update([
                ...
                'kode_jenis_pekerjaan'  =>  $request->pekerjaan_ayah11,
        ...
        DB::table('adm_ortu_ibu')
            ...
            ->update([
                ...
                'kode_jenis_pekerjaan'  =>  $request->pekerjaan_ibu11,
