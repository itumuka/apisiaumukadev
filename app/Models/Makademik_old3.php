...
class Makademik extends Model
{
    ...
    {
        $daftarmhs_pa = DB::select("SELECT akd_mahasiswa.nim, nama_mahasiswa, tahun_angkatan, nama_program_studi, akd_mahasiswa.telp AS no_hp, IF(sks_ambil > 0, 'KRS','Tidak KRS') AS status_krs
        FROM akd_mahasiswa 
    ...
    {
        $getmhs_cetak = collect(DB::select("SELECT a.nim,a.nama_mahasiswa,b.nama_program_studi, b.kode_program_studi, b.nama_program_studi, b.kode_jenjang_pendidikan, nama_fakultas, tahun_angkatan, CONCAT_WS(' ', gelar_depan, ds.nama, gelar_belakang) AS dosen_wali,(SELECT CONCAT(gelar_depan,' ',nama,' ',gelar_belakang) FROM simpeg_pegawai WHERE id=b.pimpinan_prodi) AS namaprodi 
    ...
    public function daftarmaba(Request $request)
    {
        ...
        h.alamat AS alamat_ayah,l.pekerjaan_singkatan AS pekerjaan_ayah
                ...
                LEFT JOIN mst_pekerjaan l ON h.kode_jenis_pekerjaan=l.pekerjaan_id 
                LEFT JOIN mst_pekerjaan m ON i.kode_jenis_pekerjaan=m.pekerjaan_id WHERE b.tahun LIKE '%$thn%' 
        ");
        return $daftarmaba;
    }
    // Mahasiswa Lulusan 1
    ...
    public function detail_camaba(Request $request)
    {
        ...
        h.alamat AS alamat_ayah,l.pekerjaan_singkatan AS pekerjaan_ayah
                ...
                LEFT JOIN akd_program_pendidikan k ON b.kode_program_pendidikan=k.kode_program_pendidikan 
                LEFT JOIN mst_pekerjaan l ON h.kode_jenis_pekerjaan=l.pekerjaan_id 
                LEFT JOIN mst_pekerjaan m ON i.kode_jenis_pekerjaan=m.pekerjaan_id WHERE b.id_camaba='$id_camaba'");
