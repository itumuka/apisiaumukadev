...
class Makademik extends Model
{
    ...
    public function cetakkrs(Request $request)
    {
        ...
        CONCAT_WS(' ', gelar_depan, simpeg_pegawai.nama,gelar_belakang) AS nama_dosen,akd_matakuliah.smt_matakuliah FROM akd_heregistrasi
    ...
    {
        $getmhs_cetak = collect(DB::select("SELECT a.nim,a.nama_mahasiswa,b.nama_program_studi, b.kode_program_studi, b.nama_program_studi,b.kode_jenjang_pendidikan, nama_fakultas, tahun_angkatan, CONCAT_WS(' ', gelar_depan, ds.nama, gelar_belakang) AS dosen_wali,(SELECT CONCAT(nama) FROM simpeg_pegawai WHERE id=b.pimpinan_prodi) AS namaprodi 
